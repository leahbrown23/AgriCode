    ...
    <div className="flex flex-col h-full pb-12">
      ...
      <div className="flex flex-col h-full bg-[#d1e6b2] p-6">
        <div className="w-full space-y-3">
          ...
          <input type="text" placeholder="Crop Types" className="w-full bg-white border border-gray-300 p-2 rounded" />
          <input type="text" placeholder="Size (in hectares)" className="w-full bg-white border border-gray-300 p-2 rounded" />
