    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crop_variety', models.CharField(default='Unknown', max_length=100)),
                ('start_date', models.DateTimeField()),
                ('end_date', models.DateTimeField()),
                ('yield_amount', models.FloatField()),
                ('comments', models.TextField(blank=True, default='')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('plot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.plot')),
            ],
        ),
        migrations.CreateModel(
            name='Crop',
            fields=[
                ...
                ('status', models.CharField(choices=[('planting', 'Planting'), ('growing', 'Growing'), ('harvesting', 'Harvesting'), ('closed', 'Closed')], default='planting', max_length=20)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
